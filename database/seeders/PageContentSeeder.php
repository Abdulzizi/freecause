    ...
    public function run(): void
    {
        $rows = [
            ...
            [
                ...
                'locale' => 'it',
                'key' => 'text_index_left',
                'value' => '<p>Una petizione online ti permette di raccogliere firme digitali per sostenere una causa e ottenere un vero cambiamento.</p><ul><li>Raggiungi migliaia di sostenitori istantaneamente</li><li>Presenta firme verificate ai responsabili delle decisioni</li><li>Monitora i progressi in tempo reale</li><li>Gratuita da creare, firmare e condividere</li></ul><p><a href="{FAQ_URL}">Scopri come funziona →</a></p>',
            ],
            [
                'page' => 'home',
                'locale' => 'it',
                'key' => 'text_index_right',
                'value' => '<p>Dai forza alla tua causa e fai sentire la tua voce!</p><ul><li>La piattaforma n.1 per raccogliere firme online</li><li>Sempre gratuita, senza vincoli</li><li>Condividi la tua petizione su tutti i social</li><li>Scarica le firme in PDF o DOC</li><li>Massima visibilità per la tua causa</li></ul><p><a href="{CREATE_PETITION_URL}">Lancia la tua prima petizione →</a></p>',
            ],
            ...
            ['page' => 'home', 'locale' => 'tr', 'key' => 'text_index_left', 'value' => '<p>Çevrimiçi bir dilekçe, herkese dijital imza toplayarak bir davayı destekleme ve gerçek değişim yaratma imkânı sunar.</p><ul><li>Anında binlerce destekçiye ulaşın</li><li>Doğrulanmış imzaları karar vericilere sunun</li><li>İlerlemenizi gerçek zamanlı takip edin</li><li>Oluşturmak, imzalamak ve paylaşmak ücretsiz</li></ul><p><a href="{FAQ_URL}">Nasıl çalıştığını öğrenin →</a></p>'],
            ['page' => 'home', 'locale' => 'tr', 'key' => 'text_index_right', 'value' => '<p>Davanızı güçlendirin ve sesinizi duyurun!</p><ul><li>Çevrimiçi imza toplamak için #1 platform</li><li>Her zaman ücretsiz, koşulsuz</li><li>Dilekçenizi tüm sosyal platformlarda kolayca paylaşın</li><li>İmzaları PDF veya DOC olarak indirin</li><li>Etkinizi artırmak için maksimum görünürlük</li></ul><p><a href="{CREATE_PETITION_URL}">İlk dilekçenizi şimdi başlatın →</a></p>'],
