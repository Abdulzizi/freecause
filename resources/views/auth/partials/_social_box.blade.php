<div class="mb-3">
    <div class="fw-semibold">{{ __('messages.auth.google_heading') }}</div>
...
<div class="d-flex align-items-center gap-3 my-3">
    ...
    <div class="fw-semibold" style="background:#fff;padding:0 10px;border-radius:999px;">{{ __('messages.auth.or') }}</div>
    <div style="height:1px;background:#ddd;flex:1;"></div>
</div>
