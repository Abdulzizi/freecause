            ...
            <div class="row justify-content-center">
                <div class="col-md-5">
                    <div class="fc-auth-card shadow-sm">
                        <h4 class="mb-4 text-center">{{ __('messages.auth.reset_title') }}</h4>
                        ...
                        <form method="POST" action="{{ lroute('password.update') }}">
                            ...
                            <div class="mb-3">
                                <label class="form-label">{{ __('messages.auth.new_password') }}</label>
                            ...
                            <button class="btn btn-danger w-100">{{ __('messages.auth.reset_submit') }}</button>
                        </form>
                    </div>
                </div>
            </div>
