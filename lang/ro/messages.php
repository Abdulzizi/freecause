...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    'form.title' => 'Titlu (obligatoriu)',
    'form.description' => 'Text (obligatoriu)',
    'form.goal_signatures' => 'Obiectiv (obligatoriu)',
    'form.category' => 'Categorie (obligatoriu)',
    'form.tags' => 'Tag-uri',
    'form.image' => 'Imagine (Max 4MB, JPG/PNG)',
    'form.image_external' => 'Sau furnizati un link extern:',
    'form.youtube' => 'URL video Youtube',
    'form.target' => 'Tinta petitiei',
    'form.community' => 'Comunitatea petitiei',
    'form.community_url' => 'URL comunitate',
    'form.city' => 'Oras',
    'form.submit' => 'Trimite',
    'form.preview' => 'Previzualizare',
    ...
    |--------------------------------------------------------------------------
    */
    'sign.title' => 'Semneaza aceasta petitie',
    'sign.name' => 'Nume',
    'sign.surname' => 'Prenume',
    'sign.email' => 'Email',
    'sign.password' => 'Parola',
    'sign.comment' => 'Comentariu (optional)',
    'sign.city' => 'Oras',
    'sign.nickname' => 'Nickname',
    'sign.agree1' => 'Accept Termenii de Serviciu',
    'sign.agree2' => 'Accept Politica de Confidentialitate',
    'sign.agree3' => 'Semnez aceasta petitie in nume propriu',
    'sign.submit' => 'Semneaza petitia',
    'sign.already_signed' => 'Ai semnat deja aceasta petitie.',
    'sign.thanks' => 'Multumim pentru semnatura!',
    ...
    */
    ...
    'auth.name' => 'Nume (obligatoriu)',
    'auth.surname' => 'Prenume (obligatoriu)',
    ...
    */
    ...
    'common.no_results' => 'Nu s-au gasit rezultate.',
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    'sign.page_title'      => 'Semnează - :title',
    ...
    'sign.btn'             => 'Semnează',
    'sign.btn_arrow'       => '»',
    'sign.ph_name'         => 'Nume (obligatoriu)',
    'sign.ph_surname'      => 'Prenume (obligatoriu)',
    'sign.ph_email'        => 'Email (obligatoriu)',
    'sign.ph_password'     => 'Alege o parolă (obligatoriu)',
    'sign.ph_city'         => 'Oraș (opțional)',
    'sign.ph_nickname'     => 'Pseudonim (opțional)',
    'sign.ph_comment'      => 'Comentariu',
    'sign.lbl_name'        => 'Nume (obligatoriu)',
    'sign.lbl_surname'     => 'Prenume (obligatoriu)',
    'sign.lbl_email'       => 'Email (obligatoriu)',
    'sign.lbl_password'    => 'Alege o parolă (obligatoriu)',
    'sign.lbl_city'        => 'Oraș (opțional)',
    'sign.lbl_nickname'    => 'Pseudonim (opțional)',
    'sign.lbl_comment'     => 'Comentariu',
    'sign.privacy_hint'    => 'Confidențialitate în motoarele de căutare? Poți folosi un pseudonim:',
    'sign.agree1_title'    => 'Confirm înregistrarea și sunt de acord cu <a class="red" href=":terms_url">Utilizarea și Limitările Serviciilor</a>',
    'sign.agree2_title'    => 'Confirm că am citit <a class="red" href=":privacy_url">Politica de Confidențialitate</a>',
    'sign.agree3_title'    => 'Sunt de acord cu <a class="red" href=":privacy_url">Procesarea Datelor Personale</a>',
