                ...
                <div class="col-lg-6 col-md-8">
                    ...
                    <div class="card shadow-lg border-0" style="border-radius:12px;">
                        <div class="card-body p-4 p-md-5">
                            ...
                            <h3 class="text-center mb-4">{{ trans_db('auth.create_account') }}</h3>
                            ...
                            <div class="mb-3">
                                <div class="fw-semibold">{{ trans_db('auth.register') }}</div>
                            ...
                            <form method="POST" action="{{ url("/{$locale}/register") }}">
                                ...
                                <div class="text-center">
                                    <button type="submit" class="btn btn-danger px-4 py-2" style="border-radius:8px; min-width:160px;">
                                        {{ trans_db('auth.submit') }}
                                    </button>
                                </div>

                                <div class="text-center mt-3">
                                    <span class="text-muted">{{ trans_db('auth.already_member') }}</span>
                                    <a href="{{ lroute('login') }}" class="red">{{ trans_db('auth.sign_in_now') }}</a>
                                </div>
                            </form>
