                ...
                <div class="col-lg-5 col-md-7">
                    ...
                    <div class="card shadow-lg border-0" style="border-radius:12px;">
                        <div class="card-body p-4 p-md-5">
                            ...
                            <h3 class="text-center mb-4">{{ __('messages.auth.google_heading') }}</h3>
                            ...
                            <div class="d-flex align-items-center gap-3 mb-4">
                                ...
                                <div class="fw-semibold">{{ __('messages.auth.or') }}</div>
                                <div style="height:1px;background:#ddd;flex:1;"></div>
                            </div>
                            ...
                            <form method="POST" action="{{ lroute('login.post') }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="email" name="email" value="{{ old('email') }}" class="form-control"
                                        placeholder="{{ __('messages.auth.email_placeholder') }}" required>
                                </div>
                                ...
                                <div class="text-center mt-3">
                                    <a href="{{ lroute('password.request') }}" class="red">{{ __('messages.auth.forgot_password') }}</a>
                                    <span class="text-muted px-2">|</span>
                                    <a href="{{ lroute('verification.resend.form') }}" class="red">
                                        {{ __('messages.auth.resend_verification') }}
                                    </a>
                                </div>

                                <div class="text-center mt-3">
                                    <span class="text-muted">{{ __('messages.auth.not_member') }}</span>
                                    <a href="{{ lroute('register') }}" class="red">{{ __('messages.auth.sign_up_now') }}</a>
                                </div>
                            </form>
