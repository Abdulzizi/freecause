<div style="margin-top:6px; font-size:11px; color:#555;">
    <a href="javascript:void(0)" data-bulk="all" style="margin-right:12px; text-decoration:none; color:#555;">
        <span style="display:inline-block; width:14px; text-align:center;">✓</span>
        <span>All</span>
    </a>

    <a href="javascript:void(0)" data-bulk="none" style="margin-right:12px; text-decoration:none; color:#555;">
        <span style="display:inline-block; width:14px; text-align:center;">□</span>
        <span>None</span>
    </a>

    <a href="javascript:void(0)" data-bulk="invert" style="margin-right:12px; text-decoration:none; color:#555;">
        <span style="display:inline-block; width:14px; text-align:center;">↔</span>
        <span>Invert</span>
    </a>

    @isset($banRoute)
        <a href="javascript:void(0)" data-bulk="ban" data-confirm="{{ $banConfirm ?? 'Apply action to selected items?' }}"
