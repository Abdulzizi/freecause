                    ...
                    <form method="POST" action="{{ lroute('account.profile.update') }}">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-9 d-flex gap-4">
                                <label><input type="radio" name="identify_mode" value="full" {{ $idMode === 'full' ? 'checked' : '' }}> Full Name</label>
                                <label><input type="radio" name="identify_mode" value="name" {{ $idMode === 'name' ? 'checked' : '' }}> First Name</label>
                                <label><input type="radio" name="identify_mode" value="nick" {{ $idMode === 'nick' ? 'checked' : '' }}> Nickname</label>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-sm-9 offset-sm-3">
                                <input class="form-control fc-input" name="new_email"
