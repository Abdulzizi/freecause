                ...
                <div class="col-lg-6 col-md-8">
                    ...
                    <div class="card shadow-lg border-0" style="border-radius:12px;">
                        <div class="card-body p-4 p-md-5">
                            ...
                            <h3 class="text-center mb-4">{{ __('messages.auth.create_account') }}</h3>
                            ...
                            <div class="mb-3">
                                <div class="fw-semibold">{{ __('messages.auth.register') }}</div>
                            ...
                            <form method="POST" action="{{ url("/{$locale}/register") }}">
                                ...
                                <div class="text-center mt-3">
                                    <span class="text-muted">{{ __('messages.auth.already_member') }}</span>
                                    <a href="{{ lroute('login') }}" class="red">{{ __('messages.auth.sign_in_now') }}</a>
                                </div>
                            </form>
