            ...
            <div class="fc-myp-wrap">
                <div class="row g-0">
                    ...
                    <div class="col-md-6 fc-myp-col fc-myp-left">
                        <div class="fc-myp-head">{{ __('myp.signed_heading') }}</div>
                        ...
                        <div class="fc-myp-list">
                            ...
                            @empty
                                <div class="fc-myp-empty">{{ __('myp.signed_empty') }}</div>
                            @endforelse
                    ...
                    <div class="col-md-6 fc-myp-col fc-myp-right">
                        <div class="fc-myp-head">{{ __('myp.created_heading') }}</div>
                        ...
                        <div class="fc-myp-list">
                            ...
                            @empty
                                <div class="fc-myp-empty">{{ __('myp.created_empty') }}</div>
                            @endforelse
